            ...
            <div className=" my-10 corzino">
                ...
                {basket.length === 0 ?
                    ...
                    <div>
                        ...
                        <h2 className="mb-4 ml-14"></h2>
                        <h2 className="mb-4 basketH2IK " style={{
                            fontFamily: 'Poppins',
                            fontWeight: "600",
                            fontSize: "28px",
                            lineHeight: "42px",
                                                ...
                                                <div className="  shadow-md sm:rounded-lg  ">
                                                    <div className="inline-block min-w-full align-middle">
                                                        <div className="      basketVictor  ">
                                                            ...
                                                            <div className="flex p-4 my-0.5 justify-center "
                                                                 id="alertId"
                                                                 role="alert"
                                                                 style={{background: "linear-gradient(268.51deg, #FF005C 0.86%, #000000 150.38%)"}}>
                ...
                <div>
                    ...
                    <div className="  div-basket gl:w-80  sl:w-72">

                        <div
                            className="accent-gray-500 shadow-md korzinos rounded px-8 pt-6 pb-8 mb-4  "
                            onSubmit={handleSubmit(onSubmit)}>
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2 flex "
                                       htmlFor="username">
                                    ФИО {errors.full_name &&
                                    <p className="mx-1" style={{color: "#FF005C"}}>*</p>}
                                </label>
                                <input
                                    {...register("full_name", {required: true})}
                                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="username" type="text" placeholder="Ваша имя"/>
                            </div>
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-bold mb-2 flex"
                                       htmlFor="username">
                            ...
                            <div className="inline-block relative   sl:w-62 ">
                                <label
                                    className="block text-gray-700 text-sm font-bold mb-2 flex sl:w-62 "
                                    htmlFor="username">
                                    ...
                                    <div className="inline-block relative    sl:w-62 ">
                                        <label
                                            className="block   text-gray-700 text-sm font-bold mb-2 flex sl:w-62 "
                                            htmlFor="username">
                                            Область {errors.region &&
                                            <p className="mx-1" style={{color: "#FF005C"}}>*</p>}
                                        </label>
                                        <select
                                            {...register("region", {required: true})}
                                            className="block  sever  appearance-none  sl:w-62 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow
                                leading-tight focus:outline-none focus:shadow-outline text-xl" style={{
                                        ...
                                        <div
                                            ...
                                            style={{color: "#FF005C"}}>
                                            <svg className="fill-current h-4 w-4  BTNLG "
                                    ...
                                    <button type="submit"
                                            className="sever sl:w-64 h-12 mt-9 text-white text-xl gl:w-64  flex items-center justify-center"
                                            onClick={onSubmit}
